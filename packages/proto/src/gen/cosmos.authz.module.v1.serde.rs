...
impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("cosmos.authz.module.v1.Module", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.authz.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
