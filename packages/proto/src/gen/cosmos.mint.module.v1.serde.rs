...
impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.mint.module.v1.Module", len)?;
        if !self.fee_collector_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::FeeCollectorName => {
                            ...
                            fee_collector_name__ = Some(map.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("cosmos.mint.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
