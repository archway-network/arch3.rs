...
impl<'de> serde::Deserialize<'de> for Allocation {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<Allocation, V::Error>
            where
...
impl<'de> serde::Deserialize<'de> for DenomTrace {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<DenomTrace, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut path__ = None;
...
impl<'de> serde::Deserialize<'de> for MsgTransfer {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<MsgTransfer, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut source_port__ = None;
...
impl<'de> serde::Deserialize<'de> for MsgTransferResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map: V) -> std::result::Result<MsgTransferResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for QueryTotalEscrowForDenomRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.transfer.v1.QueryTotalEscrowForDenomRequest",
                )
            }
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryTotalEscrowForDenomRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for QueryTotalEscrowForDenomResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.transfer.v1.QueryTotalEscrowForDenomResponse",
                )
            }
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryTotalEscrowForDenomResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(QueryTotalEscrowForDenomResponse { amount: amount__ })
            }
        }
        deserializer.deserialize_struct(
            "ibc.applications.transfer.v1.QueryTotalEscrowForDenomResponse",
