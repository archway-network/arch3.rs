...
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("ibc.applications.interchain_accounts.host.v1.Params", len)?;
        if self.host_enabled {
...
impl<'de> serde::Deserialize<'de> for QueryParamsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.interchain_accounts.host.v1.QueryParamsRequest",
                )
            }
...
impl<'de> serde::Deserialize<'de> for QueryParamsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.interchain_accounts.host.v1.QueryParamsResponse",
                )
            }
